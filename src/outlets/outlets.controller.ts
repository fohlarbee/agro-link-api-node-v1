...
import { OutletCreationResponse, OutletListResponse } from './entities/outlet.entity';
...
export class OutletsController {
  ...
  createOutlet(@Req() request: Record<string, any>, @Body() createData: CreateOutletDto) {
  ...
  createTable(@Req() request: Record<string, any>, @Body() tableData: CreateTableDto) {
    const { business_id: restaurantId } = request.headers;
